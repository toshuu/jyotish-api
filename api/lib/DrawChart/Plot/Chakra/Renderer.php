...
namespace Jyotish\DrawChart\Plot\Chakra;

use Jyotish\Graha\Graha;
use Jyotish\Rashi\Rashi;
use Jyotish\Varga\Varga;
use Jyotish\Base\Utility;
use Jyotish\DrawChart\Plot\Chakra\Style\AbstractChakra as Chakra;
...
class Renderer
{
    ...
    public function drawChakra(\Jyotish\Base\Data $Data, $x, $y, array $options = null)
    {
        ...
        $chakraStyle = 'Jyotish\DrawChart\Plot\Chakra\Style\\' . ucfirst($this->optionChakraStyle);
     ...
     * 
     * @param string $value
     * @return \Jyotish\DrawChart\Plot\Chakra\Renderer
